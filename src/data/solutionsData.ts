...
export const solutionsData: SolutionVertical[] = [
  {
    ...
    alignmentTable: [
      ...
      },
      {
        ...
        capability: "Automated verification logs mapping physical drive serials to Tamper-evident audit reports with certificate (Page 1: Certificate, Page 2+: Summary/Annexure)."
      },
      {
        regulation: "SOX Section 404",
        requirement: "Internal Controls Integrity",
        capability: "Tamper-evident audit trails for all data destruction events integrated into enterprise GRC systems."
      },
      {
    ...
    proceduralContent: [
      ...
      "The final and most critical stage for financial auditors is 'Verification'. D-Secure generates a 2048-bit RSA-signed Tamper-evident audit report with certificate (Page 1: Certificate, Page 2+: Summary/Annexure) for every erasure event. These reports include metadata on sector-level verification (10% or 100% checks), hardware health metrics, and the identity of the triggering agent, creating an undeniable chain of custody that withstands the scrutiny of the OCC, SEC, and global regulatory bodies."
    ],
    technicalSpecs: [
  ...
  },
  {
    ...
    proceduralContent: [
      ...
      "The result of a D-Secure healthcare deployment is an 'Audit-Ready EHR Decommissioning' Tamper-evident audit report with certificate (Page 1: Certificate, Page 2+: Summary/Annexure). This document, signed and encrypted, serves as proof of HIPAA compliance during regulatory reviews, demonstrating that the organizational 'Chain of Hygiene' remained unbroken from asset usage to final sanitization."
    ],
    technicalSpecs: [
      "DICOM-compatible metadata handling for asset tracking.",
      "Headless execution for remote clinic hardware decommissioning.",
      "Tamper-evident logs compliant with digital signature laws.",
  ...
  },
  {
    ...
    technicalSpecs: [
      ...
      "Tamper-evident metadata with hardware-level identification.",
