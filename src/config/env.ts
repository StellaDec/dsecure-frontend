...
export const ENV = {
  ...
  // Third Party
  CLOUDINARY_CLOUD_NAME: validateStr(
  ...
  RES_KEY: validateStr(
    import.meta.env.VITE_RES_KEY,
    "VITE_RES_KEY",
    false,
    "2b8A1Pv0ykhppFD28MV6ResponseKey!",
  ),
  REQ_KEY: validateStr(
    import.meta.env.VITE_REQ_KEY,
    "VITE_REQ_KEY",
    false,
    "YourEncryptionKey32CharactersLong!",
  ),
  ENC_IV: validateStr(
    import.meta.env.VITE_ENC_IV,
    "VITE_ENC_IV",
    false,
    "1234567890123456",
  ),
  FILE_ERASER: validateStr(
    import.meta.env.FileEraser,
    "FileEraser",
    false,
    "https://checkout.dodopayments.com/buy/pdt_0NVHHRwPSypqgPTs3kuSu?quantity=",
  ),
  DRIVE_ERASER: validateStr(
    import.meta.env.DriveEraser,
    "DriveEraser",
    false,
    "https://checkout.dodopayments.com/buy/pdt_0NVH5wJYMX70syW3ioj9R?quantity=",
  ),
  FileEraser_Windows_Download_Link: validateStr(
    import.meta.env.FileEraser_windows_download_link,
    "FileEraser_windows_download_link",
    false,
    "https://downloads.dsecuretech.com/windows/D-SFE_installer_v1_0_0_0.exe",
  ),
  DriveEraser_ISO_Download_Link: validateStr(
    import.meta.env.DriveEraser_iso_download_link,
    "DriveEraser_iso_download_link",
    false,
    "https://downloads.dsecuretech.com/x64x86/Drive%20Eraser/D-Secure-Drive-Eraser(v1.0.0x64-arch-amd).iso",
  ),
  DriveEraserDiagnostic_ISO_Download_Link: validateStr(
    import.meta.env.DriveEraserDiagnostic_iso_download_link,
    "DriveEraserDiagnostic_iso_download_link",
    false,
    "https://downloads.dsecuretech.com/drive-eraser-diagnostic-x64-v1/D-SECURE-DRIVE-ERASER-DIAGNOSTICS-x64-v1.0.0.0.iso",
  ),
  POWER_AUTOMATE_HTTP_URL: validateStr(
    import.meta.env.POWER_AUTOMATE_HTTP_URL,
