        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="card p-6">
            ...
            <div className="flex items-center space-x-4">
              <div className={`flex items-center space-x-2 px-4 py-2 rounded-full text-sm font-medium ${testing ? 'bg-yellow-100 text-yellow-800' :
                  apiAvailable === true ? 'bg-green-100 text-green-800' :
                    apiAvailable === false ? 'bg-red-100 text-red-800' :
                      'bg-gray-100 text-gray-800'
                }`}>
                <div className={`w-3 h-3 rounded-full ${testing ? 'bg-yellow-500' :
