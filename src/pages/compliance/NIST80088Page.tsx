...
export default function NIST80088Page() {
  const nistSchema = {
    ...
    "description": "Learn how D-Secure helps achieve NIST SP 800-88 Rev. 1 compliant data erasure for HDDs, SSDs, and storage arrays with tamper-evident audit reports.",
    "publisher": {
      "@type": "Organization",
      "name": "D-Secure",
      "logo": {
          ...
          <Reveal>
            <div className="max-w-4xl text-left">
              ...
              <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl leading-relaxed">
                Meet the gold standard for data sanitization. D-Secure provides verifiable, tamper-evident audit reports with certificate (Page 1: Certificate, Page 2+: Summary) that strictly adheres to the National Institute of Standards and Technology (NIST) Special Publication 800-88 Guidelines for Media Sanitization.
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">NIST requires verification. D-Secure generates digitally signed, tamper-evident audit reports with certificate (Page 1: Certificate, Page 2+: Summary) for every single sanitized device.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <Reveal animation="slide-left">
              <div className="bg-slate-900 rounded-2xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden">
                ...
                <h2 className="text-2xl font-bold mb-6 relative z-10">Tamper-evident audit reports with certificate</h2>
        ...
        <div className="container-app">
          <Reveal>
            ...
            <p className="text-emerald-100 text-lg mb-8 max-w-2xl mx-auto">
              Join thousands of IT asset disposition (ITAD) facilities, enterprises, and government agencies relying on D-Secure for tamper-evident audit reports with certificate.
            </p>
