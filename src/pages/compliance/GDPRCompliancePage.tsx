...
export default function GDPRCompliancePage() {
  const gdprSchema = {
    ...
    "description": "Ensure EU GDPR Article 17 (Right to be Forgotten) compliance with D-Secure's tamper-evident audit reports with certificate. Provide audit-proof deletion reports.",
    "publisher": {
      "@type": "Organization",
      "name": "D-Secure",
      "logo": {
  ...
  const requirements = [
    ...
    },
    {
      ...
      solution: "D-Secure auto-generates tamper-evident audit reports with certificate (Page 1: Certificate, Page 2+: Summary) detailing exactly when, how, and what data was erased to prove compliance to auditors."
    }
  ];
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600">Donating or recycling hardware without tamper-evident audit reports with certificate is a direct violation of GDPR principles. Formatting drives is not enough to stop data recovery.</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
            ...
            <Reveal animation="slide-left">
              <div className="bg-slate-900 rounded-2xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden">
                ...
                <h2 className="text-2xl font-bold mb-6 relative z-10">Tamper-evident audit reports with certificate for DPAs</h2>
