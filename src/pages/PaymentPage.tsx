                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 xs:grid-cols-3 sm:grid-cols-3 gap-3 xs:gap-4 sm:gap-4">
                      ...
                      <button
                        ...
                        className={`p-4 border rounded-lg text-left transition-colors ${paymentMethod === 'paypal'
                            ? 'border-brand bg-brand/5'
                            : 'border-slate-200 hover:border-slate-300'
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`p-4 border rounded-lg text-left transition-colors ${paymentMethod === 'hybrid'
                            ? 'border-brand bg-brand/5'
                            : 'border-slate-200 hover:border-slate-300'
                          }`}
                      >
