            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <section className="mb-10">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  By accessing or using D-Secure's website and services, you
              ...
              <section className="mb-10">
                ...
                <div className="space-y-4 text-slate-700 dark:text-slate-300">
                  <p className="leading-relaxed">
                    ...
                    D-Secure materials for personal, non-commercial transitory
              ...
              <section className="mb-10">
                ...
                <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-6">
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                    The materials on D-Secure's website are provided on an 'as
                    is' basis. D-Secure makes no warranties, expressed or
              ...
              <section className="mb-10">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  In no event shall D-Secure or its suppliers be liable for any
                  damages (including, without limitation, damages for loss of
                  data or profit, or due to business interruption) arising out
                  of the use or inability to use the materials on D-Secure's
                  website, even if D-Secure or a D-Secure authorized
              ...
              <section className="mb-10">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  ...
                  technical, typographical, or photographic errors. D-Secure
                  does not warrant that any of the materials on its website are
                  accurate, complete, or current. D-Secure may make changes to
              ...
              <section className="mb-10">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  D-Secure has not reviewed all of the sites linked to our
                  website and is not responsible for the contents of any such
                  linked site. The inclusion of any link does not imply
                  endorsement by D-Secure of the site. Use of any such linked
              ...
              <section className="mb-10">
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                    D-Secure may revise these terms of service for its website
              ...
              <section className="mb-10">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  ...
                  to the exclusive jurisdiction of the courts in Delhi/New
                  Delhi, India.
                </p>
              </section>
                ...
                <div className="bg-slate-50 dark:bg-slate-900/20 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-2">
                      <svg
                        className="w-5 h-5 text-purple-600 dark:text-purple-400 mt-1"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
