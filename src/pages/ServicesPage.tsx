              ...
              <div className="relative text-center">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
                  <span className="bg-gradient-to-r from-green-600 via-blue-600 to-teal-600 bg-clip-text text-transparent">
                    <span><img loading="lazy" decoding="async" src="https://res.cloudinary.com/dhwi5wevf/image/upload/f_auto,q_auto/v1759503993/ec8v6wcjdpwgpplobi3w.svg" alt="D-Secure Erase Logo" className='w-10 h-10 inline-block -mt-1' /></span> D-SecureErase
                  </span>
                  <br />
