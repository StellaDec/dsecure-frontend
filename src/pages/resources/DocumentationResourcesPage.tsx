  ...
  const documentationCategories = [
    {
      ...
      description:
        "Step-by-step implementation guides for different environments",
      ...
      {/* <section id="documentation" className="py-16 md:py-24">
        <div className="container-app">
          <div className="text-center mb-12">
            ...
            <Reveal delayMs={10}>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Comprehensive documentation organized by category for easy
                navigation.
              </p>
            </Reveal>
          </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      {category.documents.map((doc, docIndex) => (
                        ...
                        >
                          ...
                          >
                            Download{" "}
                            <ArrowDownIcon className="w-4 h-4" filled={true} />
                          </button>
                        </div>
                      ))}
                    </div>
      ...
      {/* <section className="py-16 md:py-24 bg-slate-50">
        <div className="container-app">
          <div className="text-center mb-12">
            ...
            <Reveal delayMs={10}>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Access additional resources and support channels to help you
                succeed.
              </p>
            </Reveal>
          </div>
