...
const comparisonFeatures = [
  ...
  },
  {
    ...
    dsecure: "Instant Tamper-evident audit reports with certificate (Page 1: Certificate, Page 2+: Summary)",
          ...
          <div className="container-app relative">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
                Why pay for legacy complexity? D-Secure provides enterprise-grade, tamper-evident audit reports with certificate that's faster to deploy, easier to manage, and 40% more cost-effective.
              </p>
          ...
          <div className="container-app">
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="p-8 rounded-3xl bg-white border border-slate-200 hover:border-emerald-500 hover:shadow-2xl hover:shadow-emerald-100 transition-all group">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Tamper-evident audit reports with certificate (Page 1: Certificate, Page 2+: Summary) for NIST, GDPR, and HIPAA out of the box. No extra modules or hidden costs for standard compliance reporting.
                </p>
              </div>
