...
const EnterpriseSolutionsPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHeadNative seo={getSEOForPage("enterprise-solutions")} />
      ...
      <div className="min-h-screen bg-white">
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  ...
                  <a
                    ...
                    className={`${themeClasses.button.base} ${themeClasses.button.outline} gap-2 bg-white shadow-lg`}
                  >
        ...
        <ThemeSection id="capabilities" alternate>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ThemeSectionHeading
              subtitle="Data erasure software built for large-scale operations across physical and online networks"
              centered
            >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <ThemeCard key={idx} className="group bg-[#f4fbf8]">
                  <ThemeIconContainer icon={feature.icon} className="mb-6" />
        ...
        <ThemeSection id="assets" className="bg-[#0a2e1e]" noBg>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ThemeSectionHeading
              className="[&>h2]:!text-white [&>p]:!text-emerald-100/80"
              subtitle="Achieve complete sanitization across your entire hardware fleet"
              centered
            >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <ThemeCard key={idx} className="text-center">
                  ...
                  <p className="text-sm text-[#5a6672]">{device.desc}</p>
                </ThemeCard>
              ))}
            </div>
          </div>
        ...
        <ThemeSection id="compliance">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ThemeSectionHeading
              subtitle="Approved by global bodies for safe and permanent data sanitization"
              centered
            >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <ThemeCard key={idx} className="bg-[#f4fbf8]">
                  ...
                  <p className="mb-6 text-[#5a6672]">{solution.desc}</p>
                  <ul className="space-y-2">
                    {solution.features.map((feature, fidx) => (
                      <li
                        key={fidx}
                        className="flex items-center text-sm text-[#5a6672]"
                      >
                        <svg
                          className="w-5 h-5 mr-2 flex-shrink-0 text-[#0e7c66]"
                          fill="currentColor"
                          viewBox="0 0 20 20"
                        >
                          <path
        ...
        <ThemeSection id="faq" alternate>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <ThemeSectionHeading
              subtitle="Frequently asked questions regarding our enterprise erasure platform"
              centered
            >
        ...
        <SolutionContactSection
          source="Enterprise Solutions Page"
          subjectPrefix="New Inquiry - Enterprise Solutions"
        />
      </div>
