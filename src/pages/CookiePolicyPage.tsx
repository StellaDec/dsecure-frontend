              ...
              <section className="mb-10">
                ...
                <div className="space-y-4 text-slate-700 dark:text-slate-300">
                  <p className="leading-relaxed">
                    ...
                    computer by websites you visit. They are widely used to make
                    websites work more efficiently and to provide web services
                  ...
                  <p className="leading-relaxed">
                    ...
                    cookies. Persistent cookies remain valid until their expiry
                    date (unless deleted earlier), while session cookies expire
                ...
                <div className="bg-slate-50 dark:bg-slate-900/20 border border-slate-200 dark:border-slate-700 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-2">
                      <svg
                        className="w-5 h-5 text-orange-600 dark:text-orange-400 mt-1"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
