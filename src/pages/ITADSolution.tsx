    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
              ...
              <div className="space-y-6">
                ...
                <p className="text-lg text-slate-600 leading-relaxed max-w-xl">
                  Comprehensive ITAD solution that helps organizations securely
                  retire, sanitize, and dispose of IT assets while maintaining
              ...
              <SolutionHeroGraphic
                centerIcon={
                  ...
                  >
                    ...
                    />
                    <path
                      d="M18 28 L28 20 L38 28 L38 44 L18 44 Z"
                      fill="#d1fae5"
                    />
                    <rect
                      x="42"
        ...
        <SolutionContactSection
          source="ITAD Solutions Page"
          subjectPrefix="New Inquiry - ITAD Solutions"
        />
      </div>
    </>
  );
