...
const smartphoneDiagTakeaways = [
  {
    title: "50+ Hardware Checks",
    desc: "Identify every hidden defect across iOS and Android with surgical precision.",
  },
  {
    title: "Parallel Processing",
    desc: "Evaluate up to 40 devices simultaneously to skyrocket warehouse productivity.",
  },
  {
    title: "Intelligent Grading",
    desc: "Automate objective health grades based on test results to monetize inventory.",
  },
  {
    title: "Lock & MDM Detection",
    desc: "Instant detection of FMIP, FRP, MDM supervision, and carrier/network status.",
  },
];
...
const SmartphoneDiagnosticPage = memo(() => {
  ...
  const downloadCatalog = () => {
    ...
    link.href =
      "https://assets.dsecuretech.com/pdf/DSec-SmartPhone-Diagnostic-Datasheet.pdf";
  ...
  return (
    <>
      <SEOHeadNative seo={getSEOForPage("smartphone-diagnostic")} />
      ...
      <div className="min-h-screen bg-gradient-to-br from-teal-50 via-emerald-50/30 to-slate-50">
              ...
              <Reveal>
                <div className="space-y-8">
                  ...
                  <p className="text-lg lg:text-xl text-slate-600 leading-relaxed max-w-xl">
                    Identify hardware flaws, software issues, and unlock
                    statuses instantly. The most comprehensive diagnostic tool
                    for second-hand device evaluation.
                  </p>
                  ...
                  <div className="relative flex flex-col items-center scale-[0.8] lg:scale-90 origin-top">
                    ...
                    <div className="w-[340px] h-[220px] bg-slate-800 rounded-2xl p-2.5 border-4 border-slate-700 shadow-2xl relative z-20">
                      <div className="w-full h-full bg-white rounded-lg overflow-hidden relative flex flex-col items-center justify-center border border-slate-200">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center opacity-20 overflow-hidden">
                          <svg
                            className="w-full h-24 text-teal-600"
                            viewBox="0 0 400 100"
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                          <div className="relative w-20 h-24 flex items-center justify-center">
                            <Shield
                              className="w-full h-full text-teal-600 fill-teal-50/10"
                              strokeWidth={1.5}
                            />
                    ...
                    <div className="w-32 h-10 bg-white border-2 border-slate-300 rounded-lg shadow-md flex items-center justify-around px-2 relative z-20">
                      {[1, 2, 3, 4, 5].map((i) => (
                        <div
                          key={i}
                          className="w-3 h-1.5 bg-slate-200 rounded-sm border border-slate-300"
                        ></div>
                      ))}
                    </div>
                            ...
                            <div className="relative h-full flex flex-col items-center justify-center">
                              {phone.type === "erase" ? (
                                <div className="relative w-10 h-12 flex items-center justify-center">
                                  <Shield
                                    className="w-full h-full text-emerald-600 opacity-80"
                                    strokeWidth={1}
                                  />
        ...
        <section className="bg-white py-12 border-b border-slate-100">
          <div className="container mx-auto px-4 max-w-7xl">
            <KeyTakeaways items={smartphoneDiagTakeaways} />
          </div>
        </section>
            ...
            <Reveal>
              <div className="text-center mb-16 lg:mb-24">
                <h2 className="text-3xl lg:text-5xl font-bold text-slate-900 mb-6">
                  50+ Hardware Health Checks
                </h2>
                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                  Our automated suite identifies every hidden defect across iOS
                  and Android platforms with surgical precision.
                </p>
              </div>
            </Reveal>
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <Reveal>
              <div className="text-center mb-16 lg:mb-24">
                ...
                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                  One platform to test and evaluate thousands of devices per day
                  with zero room for human error.
                </p>
              </div>
            </Reveal>
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <Reveal>
              <div className="text-center mb-16 lg:mb-24">
                ...
                <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                  Regulatory hardware diagnostics across major mobile
                  ecosystems.
                </p>
              </div>
            </Reveal>
        ...
        <section
          id="use-cases"
          className="py-20 lg:py-32 bg-slate-900 relative"
        >
            ...
            <Reveal>
              <div className="text-center mb-16 lg:mb-24">
                ...
                <p className="text-lg text-slate-400 max-w-3xl mx-auto">
                  From single-device retail shops to massive high-volume
              ...
              <Reveal>
                <div className="space-y-8">
                  <h2 className="text-3xl lg:text-5xl font-bold text-slate-900 leading-tight">
                    Intelligent{" "}
                    <span className="text-teal-600">Device Grading</span> for
                    Maximum Value
                  </h2>
                  <p className="text-lg text-slate-600 leading-relaxed">
                    Automate your valuation process. Our software assigns
                    objective health grades based on test results, helping you
                    monetize inventory with total transparency.
                  </p>
        ...
        <FAQSection
          ...
          className="!py-20 lg:!py-32 !bg-teal-50/50"
          faqs={[
            {
