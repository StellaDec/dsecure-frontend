      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50/30 to-cyan-50">
              ...
              <Reveal>
                <div className="space-y-8 text-left">
                  ...
                  {/*
                    <button
                      disabled
                      className="inline-flex items-center justify-center gap-2 bg-slate-200 text-slate-500 font-bold px-8 py-4 rounded-none shadow-none cursor-not-allowed transition-all"
                    >
                      Buy Now
                    </button>
                    */}
                    <Link
                      to="/contact"
                      className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold px-8 py-4 rounded-none shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all"
                    >
                      Contact Sales
                    </Link>
                    <button
                ...
                <div className="relative flex flex-col items-center justify-center min-h-[450px] lg:min-h-[480px] w-full max-w-2xl mx-auto overflow-visible pt-4">
                  ...
                  >
                    <div className="bg-white p-5 rounded-[2rem] shadow-2xl border border-emerald-100 w-64 lg:w-72 relative group hover:scale-105 transition-transform duration-500">
                      <div className="absolute -top-3 -right-3 bg-emerald-500 text-white p-2.5 rounded-none shadow-lg animate-pulse border-2 border-white">
                        <ShieldCheck className="w-5 h-5" />
                      </div>
                      <div className="bg-slate-900 rounded-none p-5 mb-5 relative overflow-hidden group/screen shadow-inner">
                  ...
                  <motion.div 
                    ...
                    className="relative z-20 w-44 h-8 bg-white rounded-none shadow-lg border border-slate-100 flex items-center justify-around px-4 mb-10"
                  >
                    {[1,2,3,4,5].map(i => (
        ...
        <section id="session-security" className="py-20 bg-emerald-900 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 max-w-5xl relative z-10">
            <Reveal>
              <div className="bg-white/10 backdrop-blur-md rounded-none p-10 md:p-14 border border-emerald-500/20 shadow-2xl text-center">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <Reveal className="h-full">
                <div className="p-8 lg:p-10 rounded-[2.5rem] bg-white/5 border border-white/10 hover:bg-white/10 hover:border-emerald-500/50 transition-all duration-500 flex flex-col h-full group">
                  <div className="w-14 h-14 rounded-none bg-emerald-500/10 text-emerald-400 flex items-center justify-center mb-8 border border-emerald-500/20 shadow-inner">
                  ...
                  <div className="pt-6 border-t border-white/10 flex items-center justify-between">
                    ...
                    <Link 
                      ...
                      className="inline-flex items-center gap-2 bg-emerald-500/20 px-4 py-2 rounded-none text-xs font-bold hover:bg-emerald-500/40 transition-colors"
                    >
                      Learn More <ArrowRight className="w-6 h-6 text-emerald-600" />
                    </Link>
                  </div>
                </div>
              </Reveal>
              ...
              <Reveal delayMs={100} className="h-full">
                <div className="p-8 lg:p-10 rounded-[2.5rem] bg-emerald-500 text-white shadow-2xl shadow-emerald-500/20 transform lg:-translate-y-4 transition-all duration-500 flex flex-col h-full group relative overflow-hidden">
                  ...
                  <div className="w-14 h-14 rounded-none bg-white/20 flex items-center justify-center mb-8 border border-white/30 backdrop-blur-md">
                  ...
                  <div className="bg-white/10 rounded-none p-4 mb-8 border border-white/10 backdrop-blur-sm">
                  ...
                  <div className="pt-6 border-t border-white/20 flex items-center justify-between">
                    ...
                    <Link 
                      ...
                      className="inline-flex items-center gap-2 bg-white text-emerald-600 px-4 py-2 rounded-none text-xs font-extrabold hover:bg-emerald-50 transition-colors"
                    >
                      Explore Smart <ArrowRight className="w-6 h-6 text-emerald-600" />
                    </Link>
                  </div>
                </div>
              </Reveal>
              ...
              <Reveal delayMs={200} className="h-full">
                <div className="p-8 lg:p-10 rounded-[2.5rem] bg-white/5 border border-white/10 hover:bg-white/10 hover:border-cyan-500/50 transition-all duration-500 flex flex-col h-full group">
                  <div className="w-14 h-14 rounded-none bg-cyan-500/10 text-cyan-400 flex items-center justify-center mb-8 border border-cyan-500/20 shadow-inner">
                  ...
                  <div className="pt-6 border-t border-white/10 flex items-center justify-between">
                    ...
                    <Link 
                      ...
                      className="inline-flex items-center gap-2 bg-cyan-500/20 px-4 py-2 rounded-none text-xs font-bold hover:bg-cyan-500/40 transition-colors text-cyan-400"
                    >
                      Go Advanced <ArrowRight className="w-6 h-6 text-emerald-600" />
                    </Link>
                  </div>
                </div>
              </Reveal>
                ...
                <div className="space-y-10">
                  ...
                  <div className="space-y-8">
                    <div className="flex gap-6 items-start">
                      <div className="w-12 h-12 rounded-none bg-white/5 flex items-center justify-center text-emerald-400 border border-white/10 shrink-0">
                  ...
                  <div className="bg-slate-800 rounded-[2.8rem] p-10 overflow-hidden relative shadow-2xl">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-4 text-sm font-medium p-4 bg-white/5 rounded-none border border-white/5">
              ...
              {isDemoActive ? (
                <div className="space-y-10">
                  ...
                  <div className="flex justify-center">
                    <div className="bg-white p-1.5 rounded-none shadow-lg border border-emerald-100 flex gap-2 relative z-30">
                      <button
                        onClick={() => setActiveDemoTab("admin")}
                        className={`relative z-10 flex items-center gap-2 px-6 py-3 rounded-none text-sm font-bold transition-all duration-300 ${
                          activeDemoTab === "admin"
                            ? "text-white"
                      ...
                      >
                        {activeDemoTab === "admin" && (
                          <motion.div
                            ...
                            className="absolute inset-0 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-none shadow-md"
                      ...
                      >
                        {activeDemoTab === "endpoint" && (
                          <motion.div
                            layoutId="activeTabGlow"
                            className="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-600 rounded-none shadow-md"
                            transition={{ type: "spring", bounce: 0.2, duration: 0.6 }}
                          />
                        )}
                    ...
                    <AnimatePresence mode="wait">
                      {activeDemoTab === "admin" ? (
                        ...
                        >
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div className="flex items-center gap-4">
                              <div className="w-12 h-12 rounded-none bg-emerald-500 text-white flex items-center justify-center shadow-lg shadow-emerald-500/20">
                        ...
                        >
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div className="flex items-center gap-4">
                              <div className="w-12 h-12 rounded-none bg-blue-500 text-white flex items-center justify-center shadow-lg shadow-blue-500/20">
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="relative z-10 flex flex-col items-center text-center space-y-4">
                        <div className="w-20 h-20 rounded-none bg-slate-50 text-emerald-600 flex items-center justify-center shadow-sm border border-emerald-100 group-hover/admin:scale-110 group-hover/admin:bg-emerald-600 group-hover/admin:text-white transition-all duration-500">
                    ...
                    >
                      ...
                      <div className="relative z-10 flex flex-col items-center text-center space-y-4">
                        <div className="w-20 h-20 rounded-none bg-slate-50 text-blue-600 flex items-center justify-center shadow-sm border border-blue-100 group-hover/endpoint:scale-110 group-hover/endpoint:bg-blue-600 group-hover/endpoint:text-white transition-all duration-500">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <Reveal key={item.title} delayMs={100 + idx * 50} animation="slide-up">
                  <div className="p-8 rounded-none bg-slate-50 border border-slate-100 hover:bg-cyan-50/30 hover:border-cyan-200 transition-all duration-300 h-full group">
                    <div className="w-12 h-12 rounded-none bg-white flex items-center justify-center text-cyan-600 mb-6 shadow-sm group-hover:scale-110 transition-transform">
              ...
              {[
                ...
                <Reveal key={useCase.title} delayMs={100 + idx * 50} animation="slide-up">
                  <div className="p-10 rounded-[2.5rem] bg-white/5 border border-white/10 hover:bg-white/10 hover:border-emerald-500/30 transition-all duration-500 h-full group">
                    <div className="w-14 h-14 rounded-none bg-emerald-500/10 text-emerald-400 flex items-center justify-center mb-8 shadow-inner group-hover:scale-110 transition-transform">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      ...
                      <div key={item.os} className="p-6 rounded-none bg-slate-50 border border-slate-100 flex items-center justify-between">
                         <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                     {[
                       ...
                       <div key={item.label} className="p-6 rounded-none bg-slate-50 border border-slate-100 flex justify-between items-center group hover:bg-emerald-50/50 transition-colors">
                          <span className="font-bold text-slate-700">{item.label}</span>
                          <span className="text-sm font-medium text-slate-500 bg-white px-4 py-2 rounded-none shadow-sm border border-slate-100">{item.val}</span>
                       </div>
                     ))}
                  </div>
                </div>
               ...
               {[
                 ...
                 <Reveal key={item.title} delayMs={100 + idx * 50} animation="slide-up" className="h-full">
                    <div className="p-10 rounded-[2.5rem] border border-slate-100 bg-slate-50 hover:bg-emerald-50/40 hover:border-emerald-200 transition-all duration-500 h-full group relative overflow-hidden flex flex-col">
                       ...
                       <div className="w-11 h-11 rounded-none bg-white text-emerald-600 flex items-center justify-center mb-6 group-hover:rotate-12 group-hover:scale-110 shadow-sm transition-transform border border-slate-50">
