...
export default function ReviewsPage() {
  return (
    <>
      <SEOHeadNative seo={getSEOForPage('reviews')} />
          ...
          <div className="container-responsive text-center max-w-4xl mx-auto">
            <Reveal>
              ...
              <p className="text-lg md:text-xl text-slate-600 mb-8">
                Read customer reviews of D-Secure Tech products. Real feedback from real users.
              </p>
            </Reveal>
          </div>
        </section>
            ...
            <Reveal>
              <div className="max-w-3xl mx-auto text-center">
                <p className="text-slate-600">
                  Customer reviews coming soon. Check back to see what our customers are saying.
                </p>
              </div>
            </Reveal>
          </div>
