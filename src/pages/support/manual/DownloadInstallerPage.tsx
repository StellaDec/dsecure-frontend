            ...
            <Reveal>
              <div className="text-center">
                ...
                <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                  Step-by-step guide to downloading and running the D-Secure
                  installer
                </p>
              </div>
            </Reveal>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-red-50 rounded-lg p-6">
                      ...
                      <p className="text-red-800">
                        Only download D-Secure from official sources. Verify
                        file integrity using provided checksums to ensure
                        authenticity.
                      </p>
                    </div>
                  </div>
                    ...
                    {[
                      {
                        ...
                        desc: "Find DSSecure_Setup.exe in your Downloads folder",
                      },
                      {
                        step: "2",
                        title: "Right-click and run as administrator",
                        desc: "Ensure proper permissions for installation",
                      },
                      {
                        step: "3",
                        title: "Accept UAC prompt",
                        desc: "Allow the installer to make changes to your device",
                      },
                      {
                        step: "4",
                        title: "Follow installation wizard",
                        desc: "Complete the guided setup process",
                      },
                    ].map((item, index) => (
                      <div
                        key={index}
