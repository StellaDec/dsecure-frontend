            ...
            <Reveal>
              <div className="text-center">
                ...
                <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                  How to activate your D-Secure license and verify your
                  subscription
                </p>
              </div>
            </Reveal>
                ...
                <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                  ...
                  <div className="bg-slate-100 rounded-lg p-6">
                    ...
                    <p className="text-slate-600 mt-3 text-sm">
                      Your license key consists of 25 alphanumeric characters
                ...
                <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                  ...
                  <div className="space-y-4">
                    {[
                      {
                        step: "1",
                        title: "Launch D-Secure",
                        desc: "Open the application after installation",
                      },
                      {
                        step: "2",
                        title: "Enter license key",
                        desc: "Input your 25-character license key in the activation dialog",
                      },
                      {
                        step: "3",
                        title: "Verify internet connection",
                        desc: "Ensure stable connection for online activation",
                      },
                      {
                        step: "4",
                        title: "Complete activation",
                        desc: "Wait for confirmation and restart if prompted",
                      },
                    ].map((item, index) => (
                      <div
                        key={index}
