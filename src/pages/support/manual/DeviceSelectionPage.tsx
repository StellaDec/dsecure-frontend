...
const DeviceSelectionPage: React.FC = memo(() => {
  return (
    <>
      {/* SEO Meta Tags */}
      {/* <SEOHeadNative
        seo={getSEOForPage("support-manual-device-selection", {
          title: "Device Selection | D-Secure Manual",
          canonicalUrl: "",
        })} 
      /> */}
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <Reveal>
              ...
              <p className="text-xl text-slate-700 max-w-3xl">
                Advanced device detection, filtering, and selection for targeted
                erasure operations
              </p>
            </Reveal>
          </div>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-8">
                  ...
                  <div className="bg-teal-50 p-6 rounded-lg text-center border border-teal-200">
                    ...
                    <p className="text-slate-700 text-sm">
                      Advanced filtering by type, size, status
                    </p>
                  </div>
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start">
                    <span className="text-emerald-800 mr-2">✓</span> Device
                    model, manufacturer, and serial number
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-800 mr-2">✓</span> Storage
                    capacity and interface type (SATA/NVMe/USB)
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-800 mr-2">✓</span> Current
                    status and health indicators
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-800 mr-2">✓</span> Previous
                    erasure history and timestamps
                  </li>
                </ul>
              </div>
            </Reveal>
