...
const EnterpriseBenefitsPage: React.FC = memo(() => {
  return (
    <>
      {/* SEO Meta Tags */}
      {/* <SEOHead 
        seo={getSEOForPage("support-manual-enterprise-benefits", { 
          title: "Enterprise Benefits | D-Secure Manual", 
          canonicalUrl: "/support/manual/enterprise-benefits" 
        })} 
      /> */}
            ...
            <Reveal>
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Comprehensive Enterprise Benefits guide</li>
...
export default EnterpriseBenefitsPage;
