...
const CertificateGenerationPage: React.FC = memo(() => {
  return (
    <>
      {/* <SEOHeadNative 
        seo={getSEOForPage("certifications", { 
          title: "Certificate Generation | D-Secure Manual", 
          canonicalUrl: "/support/manual/certificate-generation" 
        })} 
      /> */}
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="bg-emerald-50 rounded-lg p-6">
                      ...
                      <p className="text-sm text-slate-700 mb-4">
                        Basic erasure completion regulatory document with
                        essential details for routine operations
                      </p>
                    ...
                    <div className="bg-teal-50 rounded-lg p-6">
                      ...
                      <p className="text-sm text-slate-700 mb-4">
                        Detailed regulatory document meeting specific regulatory
                    ...
                    <div className="bg-cyan-50 rounded-lg p-6">
                      ...
                      <h3 className="font-semibold text-slate-900 mb-3">
                        Forensic Regulatory Document
                      </h3>
                      <p className="text-sm text-slate-700 mb-4">
                        Court-admissible regulatory document with cryptographic
