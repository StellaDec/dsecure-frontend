...
const ScriptingAutomationPage: React.FC = memo(() => {
           ...
           <Reveal>
             <div className="text-center">
               <h1 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
                 Scripting &{" "}
                 <span className="text-emerald-800">Automation</span>
               </h1>
               <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                 Automate D-Secure operations through command-line tools,
         ...
         <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
           <div className="space-y-12">
             ...
             <Reveal>
               <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                 <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
                   <span className="w-8 h-8 bg-emerald-500 rounded-lg flex items-center justify-center text-white text-sm font-bold mr-3">
                     1
                   </span>
                   Command Line Interface
                 </h2>
                   ...
                   <div className="bg-slate-900 rounded-lg p-6 text-green-400 font-mono text-sm">
                     <div className="mb-4">
                       <span className="text-slate-400">
                         # Basic erasure command
                       </span>
                     </div>
                     <div className="mb-2">
                       dsecure-cli --device /dev/sda --method dod --verify
                     </div>
                     <div className="mb-4">
                       <span className="text-slate-400">
                         # Batch operation with configuration file
                       </span>
                     </div>
                     <div>
                       dsecure-cli --config batch-config.json --output
                       report.xml
                     </div>
                   </div>
             ...
             <Reveal>
               <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                 <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
                   <span className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center text-white text-sm font-bold mr-3">
                     2
                   </span>
                 ...
                 <div className="space-y-6">
                   <p className="text-slate-700 leading-relaxed text-lg">
                     The <strong className="text-slate-900">Free State</strong>{" "}
                     feature serves as a proactive security mechanism designed
                     to enforce strict session-based data privacy. Rather than
                     relying on manual intervention to clear sensitive
                     information, Free State automates the process by ensuring
                     the machine restarts into a fully pristine, thoroughly
                     erased state. This zero-trust approach guarantees that no
                     residual data or user modifications persist across
                     sessions.
                   </p>
                   <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
                     ...
                     <p className="text-sm text-blue-800 leading-relaxed mb-4">
                       ...
                       eliminates data-leakage risks while drastically reducing
                       the IT overhead associated with system provisioning.
                     </p>
                     <p className="text-sm text-blue-800 font-semibold font-italic">
                       By automatically resetting environments upon every
                       reboot, organizations can confidently maintain compliance
                       and streamline operations without sacrificing security.
                     </p>
                   </div>
                 </div>
               </div>
                 ...
                 <div className="grid md:grid-cols-3 gap-6">
                   <div className="bg-emerald-50 rounded-lg p-6 text-center">
                     ...
                     <p className="text-sm text-slate-700">
                       Windows automation with PowerShell modules
                     </p>
                   </div>
                   <div className="bg-teal-50 rounded-lg p-6 text-center">
                     ...
                     <p className="text-sm text-slate-700">
                       Cross-platform automation with Python SDK
                     </p>
                   </div>
                   <div className="bg-cyan-50 rounded-lg p-6 text-center">
                     ...
                     <p className="text-sm text-slate-700">
                       Unix/Linux shell scripting support
                     </p>
                   </div>
                 </div>
               </div>
             ...
             <Reveal>
               <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                 <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
                   <span className="w-8 h-8 bg-cyan-500 rounded-lg flex items-center justify-center text-white text-sm font-bold mr-3">
                     4
                   </span>
 ...
 "email": "admin@company.com"
             ...
             <Reveal>
               <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                 <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
                   <span className="w-8 h-8 bg-teal-600 rounded-lg flex items-center justify-center text-white text-sm font-bold mr-3">
                     6
                   </span>
             ...
             <Reveal>
               <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                 <h2 className="text-2xl font-bold text-slate-900 mb-6 flex items-center">
                   <span className="w-8 h-8 bg-cyan-600 rounded-lg flex items-center justify-center text-white text-sm font-bold mr-3">
                     7
                   </span>
                   Automation Benefits
                 </h2>
