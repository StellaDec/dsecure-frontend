            ...
            <Reveal>
              <div className="text-center">
                ...
                <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                  HDD, SSD, hybrid drives and file systems overview for D-Secure
                  erasure
                </p>
              </div>
            </Reveal>
                ...
                <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                  ...
                  <div className="space-y-4">
                    {[
                      {
                        name: "NTFS",
                        desc: "Primary Windows file system with journaling and encryption support",
                        erasure: "Cipher command effective",
                      },
                      {
                        name: "FAT32",
                        desc: "Legacy file system for compatibility and removable media",
                        erasure: "Standard overwrite methods work",
                      },
                      {
                        name: "exFAT",
                        desc: "Extended FAT for large files and cross-platform compatibility",
                        erasure: "Similar to FAT32 approach",
                      },
                      {
                        name: "ReFS",
                        desc: "Resilient File System for Windows Server environments",
                        erasure: "Advanced metadata handling required",
                      },
                    ].map((fs, index) => (
                      <div
                        key={index}
