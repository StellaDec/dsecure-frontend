...
const FirewallSetupPage: React.FC = memo(() => {
  return (
    <>
      {/* SEO Meta Tags */}
      {/* <SEOHeadNative 
        seo={getSEOForPage("support-manual-firewall-setup", { 
          title: "Firewall Setup | D-Secure Manual", 
          canonicalUrl: "/support/manual/firewall-setup" 
        })} 
      /> */}
                ...
                <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-orange-50 rounded-lg p-6 text-center">
                      ...
                      <p className="text-sm text-slate-700 mb-3">
                        Enhanced security with custom rules
                      </p>
                    ...
                    <div className="bg-red-50 rounded-lg p-6 text-center">
                      ...
                      <p className="text-sm text-slate-700 mb-3">
                        Strictest security for sensitive data
                      </p>
                ...
                <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                  ...
                  <div className="space-y-4">
                    {[
                      {
                        step: "1",
                        title: "Access Firewall Settings",
                        desc: "Navigate to Settings > Network Protection > Firewall",
                      },
                      {
                        step: "2",
                        title: "Choose Protection Level",
                        desc: "Select Basic, Advanced, or Maximum security level",
                      },
                      {
                        step: "3",
                        title: "Configure Application Rules",
                        desc: "Set permissions for specific applications",
                      },
                      {
                        step: "4",
                        title: "Network Zone Settings",
                        desc: "Define trusted networks (home, work, public)",
                      },
                      {
                        step: "5",
                        title: "Port Configuration",
                        desc: "Open or block specific ports as needed",
                      },
                      {
                        step: "6",
                        title: "Apply and Test",
                        desc: "Save settings and verify network connectivity",
                      },
                    ].map((item, index) => (
                      <div
                        key={index}
                  ...
                  <div className="space-y-4">
                    <div className="bg-blue-50 rounded-lg p-6">
                      ...
                      <p className="text-blue-800 mb-3">
                        Networks you trust completely (home, office)
                      </p>
                    ...
                    <div className="bg-yellow-50 rounded-lg p-6">
                      ...
                      <p className="text-yellow-800 mb-3">
                        Unknown networks (coffee shops, airports)
                      </p>
