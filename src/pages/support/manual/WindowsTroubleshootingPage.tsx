                    ...
                    {[
                      {
                        ...
                        solution:
                          "Update drivers, check SATA connections, try different USB port",
                      },
                      {
                        issue: "BitLocker Access Denied",
                        cause: "Insufficient permissions or locked drive",
                        solution:
                          "Run as administrator, unlock BitLocker first, suspend protection",
                      },
                      {
                        issue: "Erasure Process Stuck",
                        cause: "Bad sectors or hardware failure",
                        solution:
                          "Check disk health, run CHKDSK, try different erasure method",
                      },
                      {
                        issue: "SSD Secure Erase Failed",
                        cause: "Drive locked or unsupported command",
                        solution:
                          "Check ATA security status, use manufacturer tool, try hdparm",
                      },
                    ].map((item, index) => (
                      <div
                        key={index}
                ...
                <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                  ...
                  <div className="space-y-4">
                    {[
                      {
                        code: "0x80070005",
                        desc: "Access Denied - Run as administrator",
                      },
                      {
                        code: "0x80070015",
                        desc: "Device not ready - Check connections",
                      },
                      {
                        code: "0x8007001F",
                        desc: "Device error - Hardware issue",
                      },
                      {
                        code: "0x80070057",
                        desc: "Invalid parameter - Check command syntax",
                      },
                    ].map((error, index) => (
                      <div
                        key={index}
