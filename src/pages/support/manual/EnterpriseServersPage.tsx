              ...
              <Reveal>
                <div className="text-center">
                  ...
                  <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                    Comprehensive guide to D-Secure enterprise server erasure
                    for data centers and virtualization platforms
                  </p>
                </div>
              </Reveal>
            </div>
                  ...
                  <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                    ...
                    <div className="space-y-4">
                      <p className="text-slate-700">
                        D-Secure enterprise server erasure meets the highest
                        compliance standards for data center operations.
                      </p>
