...
const WindowsIntroductionPage: React.FC = memo(() => {
  return (
    <>
      {/* SEO Meta Tags */}
      {/* <SEOHead 
        seo={getSEOForPage("support-manual-windows-introduction", { 
          title: "Windows Introduction | D-Secure Manual", 
          canonicalUrl: "/support/manual/windows-introduction" 
        })} 
      /> */}
            ...
            <Reveal>
              <div className="text-center">
                ...
                <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                  Understanding the importance of secure data erasure in Windows
                  environments
                </p>
              </div>
            </Reveal>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="space-y-12">
              <Reveal>
                <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                  <h2 className="text-2xl font-bold text-slate-900 mb-6">
                    Why Windows Data Erasure Matters
                  </h2>
                  <div className="prose prose-slate max-w-none">
                    <p className="text-slate-700 mb-4">
                      Windows systems store data across multiple locations
                      including system files, registry entries, temporary files,
                      and hidden partitions. Simple deletion or formatting
                      doesn't remove this data permanently.
                    </p>
              ...
              <Reveal>
                <div className="bg-white rounded-xl p-8 shadow-sm border border-slate-200">
                  <h2 className="text-2xl font-bold text-slate-900 mb-6">
                    Windows Data Storage Locations
                  </h2>
                  <div className="space-y-4">
                    {[
                      {
                        title: "System Files",
                        desc: "Windows registry, system logs, and configuration files",
                      },
                      {
                        title: "User Data",
                        desc: "Documents, downloads, desktop files, and application data",
                      },
                      {
                        title: "Temporary Files",
                        desc: "Browser cache, system temp files, and application caches",
                      },
                      {
                        title: "Hidden Areas",
                        desc: "Swap files, hibernation files, and system restore points",
                      },
                    ].map((item, index) => (
                      <div
                        key={index}
