    ...
    <>
      {/* <SEOHeadNative 
        seo={getSEOForPage("help-manual", { 
          title: "Windows Enterprise | D-Secure Manual", 
          canonicalUrl: "/support/manual/windows-enterprise" 
        })} 
      /> */}
            ...
            <Reveal>
              <div className="text-center">
                ...
                <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                  SCCM, Intune, and network-based methods for D-Secure bulk
                  operations
                </p>
              </div>
            </Reveal>
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        },
                        {
                          ...
                          desc: "Apply erasure policies based on device groups",
                        },
                        {
                          step: "3",
                          title: "Scheduled Execution",
                          desc: "Execute erasure during maintenance windows",
                        },
                        {
                          step: "4",
                          title: "Compliance Reporting",
                          desc: "Generate audit reports and regulatory documents",
                        },
                      ].map((item) => (
                        <div
                          key={item.step}
