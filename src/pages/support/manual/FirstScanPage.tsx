                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-700 mb-4">
                          We recommend running a complete full system scan for
                          your first scan to establish a comprehensive security
                          baseline.
                        </p>
                    ...
                    {[
                      {
                        step: "1",
                        title: "Open D-Secure",
                        desc: "Launch the application from desktop shortcut or Start menu",
                      },
                      {
                        step: "2",
                        title: "Navigate to Scan",
                        desc: "Click on 'Scan' tab in the main interface",
                      },
                      {
                        step: "3",
                        title: "Select Full Scan",
                        desc: "Choose 'Full System Scan' from scan options",
                      },
                      {
                        step: "4",
                        title: "Start Scan",
                        desc: "Click 'Start Scan' button to begin the process",
                      },
                      {
                        step: "5",
                        title: "Monitor Progress",
                        desc: "Watch real-time progress and scan statistics",
                      },
                      {
                        step: "6",
                        title: "Review Results",
                        desc: "Examine scan report when complete",
                      },
                    ].map((item, index) => (
                      <div
                        key={index}
