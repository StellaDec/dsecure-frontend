    ...
    return (
      <>
        ...
        seo={getSEOForPage("help-manual", { 
          title: "Custom Configurations | D-Secure Manual", 
          canonicalUrl: "/support/manual/custom-configurations" 
        })} 
      /> */}
              ...
              <Reveal>
                <div className="text-center">
                  <h1 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-4">
                    Custom{" "}
                    <span className="text-emerald-800">Configurations</span>
                  </h1>
                  <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                    Create custom D-Secure erasure profiles and organization
                    policies tailored to your specific requirements
                  </p>
                </div>
              </Reveal>
            </div>
                    ...
                    <div className="space-y-6">
                      <div className="bg-slate-50 rounded-lg p-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          ...
                          <div className="bg-white rounded-lg p-4 border border-slate-200">
                            <h4 className="font-medium text-teal-600 mb-3">
                              Step 2: Verification
                            </h4>
                            <div className="space-y-2">
                              <div className="flex items-center space-x-2">
