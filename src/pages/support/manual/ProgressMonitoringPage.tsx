...
const ProgressMonitoringPage: React.FC = memo(() => {
  return (
    <>
      {/* SEO Meta Tags */}
      {/* <SEOHead 
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <Reveal>
              ...
              <p className="text-xl text-slate-700 max-w-3xl">
                Track erasure progress, performance metrics, and estimated
                completion times
              </p>
            </Reveal>
          </div>
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="bg-cyan-50 p-6 rounded-lg border border-cyan-200">
                    ...
                    <p className="text-slate-700">
                      Current data processing speed in MB/s or GB/s
                    </p>
                  </div>
                  <div className="bg-emerald-50 p-6 rounded-lg border border-emerald-200">
                    <h3 className="font-bold text-emerald-900 mb-3">
                    ...
                    <p className="text-slate-700">
                      Current pass number and total passes required
                    </p>
                  </div>
                </div>
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start">
                    <span className="text-emerald-800 mr-2">✓</span> CPU and
                    memory utilization during erasure
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-800 mr-2">✓</span> Disk I/O
                    performance and bottleneck detection
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-800 mr-2">✓</span> Temperature
                    monitoring for device health
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-800 mr-2">✓</span> Historical
