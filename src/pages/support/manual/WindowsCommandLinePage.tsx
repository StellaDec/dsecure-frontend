...
const WindowsCommandLinePage: React.FC = memo(() => {
  return (
    <>
      {/* SEO Meta Tags */}
      {/* <SEOHeadNative 
        seo={getSEOForPage("support-manual-windows-command-line", { 
          title: "Windows Command Line | D-Secure Manual", 
          canonicalUrl: "/support/manual/windows-command-line" 
        })} 
      /> */}
            ...
            <Reveal>
              <div className="text-center">
                ...
                <p className="text-xl text-slate-700 max-w-3xl mx-auto">
                  Cipher, Diskpart, and PowerShell scripting methods
                </p>
              </div>
            </Reveal>
          </div>
...
# Diskpart - Clean disk completely
diskpart
list disk
select disk 1
clean all

# PowerShell - Secure file deletion
