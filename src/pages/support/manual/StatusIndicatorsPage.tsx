            ...
            <Reveal>
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Real-time notifications for operation status changes</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Email alerts for critical events and completions</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Customizable alert thresholds and preferences</li>
                  <li className="flex items-start"><span className="text-emerald-800 mr-2">✓</span> Alert history and acknowledgment tracking</li>
                </ul>
              </div>
            </Reveal>
          </div>
