...
const WindowsFilesystemsPage: React.FC = memo(() => {
  return (
    <>
      {/* SEO Meta Tags */}
      {/* <SEOHead 
        seo={getSEOForPage("support-manual-windows-filesystems", { 
          title: "Windows Filesystems | D-Secure Manual", 
          canonicalUrl: "/support/manual/windows-filesystems" 
        })} 
      /> */}
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-emerald-50 rounded-lg p-6">
                      ...
                      <ul className="space-y-2 text-emerald-800">
                        ...
                        <li>
                          • Security: Access Control Lists (ACLs) and encryption
                          support
                        </li>
                        <li>
                        ...
                        <li>
                          • Alternate Data Streams: Hidden data storage within
                          files
                        </li>
                      </ul>
                    </div>
                    <div className="bg-teal-50 rounded-lg p-6">
                      ...
                      <ul className="space-y-2 text-teal-800">
                        <li>
                          • Master File Table (MFT) contains file metadata
                        </li>
                        <li>• Journal files record file system changes</li>
                        <li>
                          • Alternate Data Streams can hide sensitive
                          information
                        </li>
                        <li>• File slack space may contain data remnants</li>
                        <li>
                          • Deleted file entries remain in MFT until overwritten
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-blue-50 rounded-lg p-6">
                      ...
                      <ul className="space-y-2 text-blue-800">
                        ...
                        <li>
                          • Directory entries store file names and attributes
                        </li>
                      </ul>
                    </div>
                    <div className="bg-cyan-50 rounded-lg p-6">
                      ...
                      <ul className="space-y-2 text-cyan-800">
                        ...
                        <li>
                          • Cluster boundary alignment for complete erasure
                        </li>
                      </ul>
                    </div>
                  </div>
