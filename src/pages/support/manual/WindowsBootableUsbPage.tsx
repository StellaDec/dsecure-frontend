              ...
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="space-y-3 text-slate-700">
                  <li className="flex items-start">
                    ...
                    Comprehensive Windows Bootable Usb guide
                  </li>
                  <li className="flex items-start">
                    <span className="text-emerald-800 mr-2">✓</span>{" "}
                ...
                <h2 className="text-3xl font-bold text-slate-900 mt-12 mb-6">
                  Required Tools: UNetbootin
                </h2>
                <p className="text-slate-700 mb-4">
                  To create a bootable USB, we recommend using UNetbootin.
                  Please download the appropriate version for your operating
                  system:
                </p>
