...
const GetStartedPage: React.FC = memo(() => {
  ...
  const deviceGuides: DeviceGuide[] = [
    {
      ...
      title: "Windows PC",
      description:
        "Complete data erasure for Windows desktops and laptops with multiple drive types",
      icon: "🖥️",
      difficulty: "Easy",
    ...
    },
    {
      ...
      title: "Mac Computer",
      description:
        "Secure erasure for Intel and Apple Silicon Mac systems with FileVault support",
      icon: "🍎",
      difficulty: "Medium",
  ...
  return (
    <>
      <SEOHeadNative seo={getSEOForPage("get-started")} />
      ...
      <div className="min-h-screen bg-slate-50">
              ...
              <div className="text-center">
                <div className="mb-8">
                  ...
                  <p className="text-xl text-slate-700 max-w-3xl mx-auto mb-8">
                    Learn how to securely wipe data from PC, Mac, Server &
                    Mobile devices with step-by-step guides
                  </p>
                </div>
              </div>
            </Reveal>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Reveal delayMs={100}>
                <div className="text-center">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Select your device type from the options below to get
              ...
              <Reveal delayMs={200}>
                <div className="text-center">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Follow our detailed step-by-step instructions tailored for
                    your specific device and requirements.
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal delayMs={300}>
                <div className="text-center">
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Confirm the erasure was successful and generate regulatory
                    documents for compliance and audit purposes.
                  </p>
                </div>
              </Reveal>
            </div>
        ...
        <section className="py-16 md:py-24 bg-slate-50">
          <div className="container-responsive">
            ...
            <div
              className={`grid gap-6 mb-12 ${deviceGuides.length <= 2 ? "md:grid-cols-2 max-w-3xl mx-auto" : "md:grid-cols-2 lg:grid-cols-4"}`}
            >
                  ...
                  >
                    <div className="text-center">
                      ...
                      <div className="flex items-center justify-center gap-2 mb-3">
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium ${getDifficultyColor(device.difficulty)}`}
                        >
                          {device.difficulty}
                        </span>
            ...
            {selectedDevice && (
              <Reveal>
                {(() => {
                  const device = deviceGuides.find(
                    ...
                    <div className="bg-white rounded-xl shadow-lg border border-emerald-200 p-8">
                      <div className="text-center mb-8">
                        ...
                        <div className="flex items-center justify-center gap-4 mb-4">
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-medium ${getDifficultyColor(device.difficulty)}`}
                          >
                            {device.difficulty}
                          </span>
                          <span className="text-slate-600">
                            Estimated time: {device.estimatedTime}
                          </span>
                        </div>
              ...
              {[
                {
                  ...
                  description:
                    "Get the latest version of D-Secure for your operating system",
                  icon: "⬇️",
                  url: "/download",
                  color: "bg-blue-500",
                },
                ...
                },
                {
                  ...
                  description:
                    "Get help from our expert technical support team",
                  icon: "🔧",
                  url: "/support",
                  color: "bg-purple-500",
                },
            ...
            <Reveal>
              <div className="text-center text-white">
                ...
                <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                  Our support team is here to guide you through your first data
                  erasure operation
                </p>
