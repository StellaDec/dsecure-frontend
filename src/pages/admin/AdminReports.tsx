...
export default function AdminReports() {
  ...
  const filteredReports = useMemo(() => {
    ...
    return mockReports.filter((report) => {
      ...
      const matchesEraseType =
        !reportFilters.eraseType ||
        report.reportType.includes(reportFilters.eraseType);
      const matchesStatus =
        !reportFilters.eraseStatus ||
        report.status === reportFilters.eraseStatus;
      const matchesEmail =
        !reportFilters.email || report.department.includes(reportFilters.email);
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setReportFilters({
                          ...reportFilters,
                          eraseType: e.target.value || undefined,
                        })
                      }
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setReportFilters({
                          ...reportFilters,
                          eraseStatus: e.target.value || undefined,
                        })
                      }
                      className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500"
                    >
