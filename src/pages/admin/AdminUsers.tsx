            ...
            <table className="w-full">
              <thead>
                <tr className="text-left text-xs sm:text-sm text-slate-500 border-b border-slate-200">
                  <th className="px-4 sm:px-6 py-4 font-medium min-w-[160px]">
                    User
                  </th>
                  <th className="px-4 py-4 font-medium">Role</th>
                  <th className="px-4 py-4 font-medium">Status</th>
                  <th className="px-4 py-4 font-medium min-w-[120px]">Group</th>
                  <th className="px-4 py-4 font-medium text-center">
                    Licenses
                  </th>
                  <th className="px-4 py-4 font-medium min-w-[100px]">
                    Last Login
                  </th>
                  <th className="px-4 py-4 font-medium text-right sm:text-left">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-200">
                {filteredUsers.map((user) => (
                  <tr key={user.id} className="hover:bg-slate-50">
                    ...
                    <td
                      className="px-4 py-4 text-slate-600 truncate max-w-[150px]"
                      title={user.group}
                    >
                      {user.group}
                    </td>
                    ...
                    <td className="px-4 py-4">
                      <div className="flex items-center justify-end sm:justify-start gap-2 whitespace-nowrap">
                        <button
                          onClick={() =>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      Update license count for {selectedUser.name}
                    </p>
                  </div>
                </div>
