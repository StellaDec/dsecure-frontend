          ...
          <Reveal>
            <div className="text-center px-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0a2e1e] mb-8 leading-tight">
                Securely Erase Data on Servers with D-Secure <Link to="/products/drive-eraser" className="text-[#0e7c66] hover:underline font-medium">Drive Eraser</Link>
              </h1>
        ...
        <section className="max-w-[95%] lg:max-w-6xl mx-auto px-4 md:px-8 py-12">
          <Reveal>
            <div className="prose prose-emerald prose-lg md:prose-xl max-w-none prose-headings:font-bold prose-headings:text-[#0a2e1e] prose-p:leading-loose text-[#5a6672] text-justify mb-8">
              ...
              <p className="text-lg text-[#5a6672] leading-loose mb-6">
                ...
                disposition (<Link to="/solutions/itad" className="text-[#0e7c66] hover:underline font-medium">ITAD</Link>) managers must securely wipe data before
                retirement or reuse. <Link to="/solutions/service-providers" className="text-[#0e7c66] hover:underline font-medium">Managed service providers</Link> (MSPs) have
          ...
          <Reveal>
            <div className="prose prose-emerald prose-lg md:prose-xl max-w-none prose-headings:font-bold prose-headings:text-[#0a2e1e] prose-p:leading-loose text-[#5a6672] text-justify mb-8">
              ...
              <p className="text-lg text-[#5a6672] leading-loose mb-6">
                D-Secure <Link to="/products/drive-eraser" className="text-[#0e7c66] hover:underline font-medium">Drive Eraser</Link> provides robust data erasure capabilities
          ...
          <Reveal>
            <div className="bg-[#0e7c66] rounded-none shadow-none p-10 mt-10 text-white">
              ...
              <p className="text-lg leading-loose mb-8">
                D-Secure <Link to="/products/drive-eraser" className="text-white hover:underline font-medium">Drive Eraser</Link> offers flexible deployment options to
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/10 rounded-none p-6">
                  ...
                  <p className="text-white/90 leading-relaxed mb-4">
                    Perform remote <Link to="/products/drive-eraser" className="text-white hover:underline font-medium">data wiping</Link> using server's lights-out
                  ...
                  <ul className="space-y-2 text-white/90">
                    ...
                    <li>• <Link to="/products/drive-eraser" className="text-white hover:underline font-medium">Secure erasure</Link> from centralized console</li>
