          ...
          <Reveal>
            <div className="text-center px-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-8 leading-tight">
                Securely Erase Data on Servers with D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link>
              </h1>
              <p className="text-xl md:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                Discover how D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link> can securely wipe servers and
        ...
        <section className="max-w-[95%] lg:max-w-6xl mx-auto px-4 md:px-8 py-12">
          <Reveal>
            <div className="bg-white rounded-2xl shadow-lg border border-sky-100 p-8 md:p-12 space-y-10 text-justify">
              ...
              <p className="text-lg text-slate-700 leading-loose mb-6">
                ...
                disposition (<Link to="/solutions/itad" className="text-sky-600 hover:underline font-medium">ITAD</Link>) managers must securely wipe data before
                retirement or reuse. <Link to="/solutions/service-providers" className="text-sky-600 hover:underline font-medium">Managed service providers</Link> (MSPs) have
          ...
          <Reveal>
            <div className="bg-white rounded-2xl shadow-lg border border-sky-100 p-8 md:p-12 space-y-10 text-justify">
              ...
              <p className="text-lg text-slate-700 leading-loose mb-6">
                D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link> provides robust data erasure capabilities
          ...
          <Reveal>
            <div className="bg-gradient-to-br from-sky-600 via-blue-600 to-sky-600 rounded-xl shadow-lg p-10 mt-10 text-white">
              ...
              <p className="text-lg leading-loose mb-8">
                D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link> offers flexible deployment options to
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/10 rounded-xl p-6">
                  ...
                  <p className="text-white/90 leading-relaxed mb-4">
                    Perform remote <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">data wiping</Link> using server's lights-out
                  ...
                  <ul className="space-y-2 text-white/90">
                    ...
                    <li>• <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Secure erasure</Link> from centralized console</li>
          ...
          <Reveal>
            <div className="bg-white rounded-2xl shadow-lg border border-sky-100 p-8 md:p-12 space-y-10 text-justify">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="font-bold text-sky-700 text-lg mb-4">
