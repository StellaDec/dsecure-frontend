        ...
        <Reveal>
          <div className="bg-white rounded-xl shadow border p-10 space-y-8 text-lg leading-loose text-slate-700">
            ...
            <p>
              ...
              <Link to="/products/drive-eraser" className="text-emerald-600 hover:underline font-medium">secure erasure</Link> across thousands of endpoints, servers, and mobile
              devices is operationally complex. This is where Erasure as a
              Service (EAAS), delivered by <Link to="/solutions/service-providers" className="text-emerald-600 hover:underline font-medium">Managed Service Providers</Link> (MSPs),
              Managed Security Service Providers (MSSPs), and IT Asset
              Disposition (<Link to="/solutions/itad" className="text-emerald-600 hover:underline font-medium">ITAD</Link>) companies, becomes indispensable.
            </p>
            ...
            <p>
              ...
              deliver <Link to="/products/drive-eraser" className="text-emerald-600 hover:underline font-medium">secure erasure</Link> services across diverse device ecosystems
            ...
            <p>
              D-Secure <Link to="/products/drive-eraser" className="text-emerald-600 hover:underline font-medium">Drive Eraser</Link> is a powerful, multi-platform solution
              designed for permanent data removal from desktops, laptops, Macs,
              and servers. It supports flexible deployment models including
              Cloud, Network, PXE Boot, and Offline environments. The platform
              complies with more than 24 globally recognized sanitization
              standards, such as NIST SP 800-88 Clear & Purge, US DoD 5220.22,
              NATO, and CSEC ITSG-06.
            </p>

            <p>
              Beyond wiping, the solution generates tamper-proof erasure
            ...
            <p>
              ...
              maintain a secure repository of erasure reports. The platform is
              capable of sanitizing over 65,000 drives concurrently across
            ...
            <p>
              For mobile device environments, D-Secure offers an advanced
              erasure and diagnostic solution for Android and iOS platforms. The
              software supports internationally approved standards such as NIST
              800-88, DoD, and HMG, and can be deployed on Windows, macOS, or
              dedicated Linux-based workstations for parallel processing of
              multiple devices.
            </p>

            <p>
              Integrated diagnostics capabilities perform more than 50 automated
              and manual tests, enabling service providers to assess device
              health and maximize resale or reuse value while generating
              verifiable erasure certificates for compliance.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Cost Efficiency:</strong> Flexible, pay-per-use
                licensing and volume discounts tailored for service providers.
              </li>
              <li>
                <strong>Mass Scalability:</strong> Network-based wiping of tens
                of thousands of drives and simultaneous mobile device
                processing.
              </li>
              <li>
                <strong>Certified Trust:</strong> Validated by international
                bodies such as NIST, Common Criteria, ADISA, STQC, and others.
              </li>
              <li>
                <strong>Regulatory Alignment:</strong> Supports compliance with
                GDPR, CPRA, HIPAA, GLBA, SOX, ISO 27001, PDPL, PIPEDA, DPDPA,
                LGPD, and additional regional privacy laws.
              </li>
              <li>
                <strong>Operational Streamlining:</strong> Centralized
                reporting, API integrations, ISO customization, and cloud-based
                certificate management.
              </li>
              <li>
                <strong>Expert Support:</strong> Dedicated technical assistance
                for deployment, integration, and large-scale operations.
              </li>
            </ul>
