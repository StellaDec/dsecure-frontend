      ...
      <section className="py-16 bg-white shadow-lg">
        <Reveal>
          <div className="text-center px-6">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-8 leading-tight max-w-5xl mx-auto">
          ...
          <div className="lg:col-span-8">
            <Reveal>
              <div className="prose prose-lg prose-slate max-w-none text-justify">
                ...
                <h2 className="text-2xl font-bold text-slate-900 mb-6">Why NIST Retired a Standard That Had Been Stable Since 2014</h2>
                ...
                <h2 className="text-3xl font-bold text-slate-900 mb-8 pb-4 border-b border-slate-200">What NIST 800-88 Rev. 2 Actually Changes</h2>

                <h3 className="text-xl font-bold text-slate-900 mb-4 mt-8">1. Sanitization Is Now a Program, Not a Task</h3>
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 mt-8">2. The Decision Flow Now Starts With Confidentiality and Reuse — Not With Device Tables</h3>
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 mt-8">3. Verification and Validation Are Now Two Separate Processes</h3>
                <p className="text-slate-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 mt-8">4. Digital Audit Trails Are No Longer Optional</h3>
                <p className="text-slate-700 leading-relaxed mb-8">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 mt-8">5. Single-Pass Overwrite Is Now Considered Sufficient for Modern HDDs</h3>
                <p className="text-slate-700 leading-relaxed mb-8">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 mt-8">6. Degaussing Is Downgraded — A Change Most Guides Are Missing</h3>
                <p className="text-slate-700 leading-relaxed mb-8">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 mt-8">7. Cryptographic Erase Gets Formal Treatment — and a Quantum-Era Caveat</h3>
                <p className="text-slate-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 mt-8">8. Expanded Scope: Cloud, Virtual, and Shared Infrastructure</h3>
                <p className="text-slate-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 mt-8">9. Method Selection Now Points to IEEE 2883-2022</h3>
                <p className="text-slate-700 leading-relaxed mb-12">
                ...
                <h2 className="text-3xl font-bold text-slate-900 mb-6">Rev. 1 vs. Rev. 2 — Quick Comparison</h2>
                <div className="overflow-x-auto mb-12">
                  <table className="w-full border-collapse bg-white rounded-xl shadow-sm border border-slate-200 text-left">
                    <thead>
                      <tr className="bg-slate-900 text-white">
                        <th className="px-6 py-4">Area</th>
                        <th className="px-6 py-4">Rev. 1 (2014, Withdrawn)</th>
                        <th className="px-6 py-4 text-blue-400">Rev. 2 (2025, Current)</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-200">
                      <tr>
                        <td className="px-6 py-4 font-semibold text-slate-800">Framing</td>
                        <td className="px-6 py-4 text-slate-600">One-time technical task</td>
                        <td className="px-6 py-4 text-blue-700 font-medium">Ongoing organizational program</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-semibold text-slate-800">Decision starting point</td>
                        <td className="px-6 py-4 text-slate-600">Choose a wiping technique from device tables</td>
                        <td className="px-6 py-4 text-blue-700 font-medium">Classify data confidentiality and reuse intent first</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-semibold text-slate-800">Device-specific tables</td>
                        <td className="px-6 py-4 text-slate-600">Included directly, by device type</td>
                        <td className="px-6 py-4 text-blue-700 font-medium">Removed — deferred to IEEE 2883-2022 to avoid obsolescence</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-semibold text-slate-800">Verification</td>
                        <td className="px-6 py-4 text-slate-600">Loosely defined</td>
                        <td className="px-6 py-4 text-blue-700 font-medium">Formally separated from Validation</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-4 font-semibold text-slate-800">Cloud / VM / shared storage</td>
                        <td className="px-6 py-4 text-slate-600">Not addressed</td>
                        <td className="px-6 py-4 text-blue-700 font-medium">Explicitly in scope, with KMS + Certificate of Deletion expectations</td>
                      </tr>
                    </tbody>
                  </table>
                </div>

                <h2 className="text-3xl font-bold text-slate-900 mb-6">What This Means for Indian Enterprises Under the DPDP Act</h2>
                <p className="text-slate-700 leading-relaxed mb-6">
                ...
                <ul className="list-disc pl-6 space-y-3 text-slate-700 mb-12">
                ...
                <h2 className="text-3xl font-bold text-slate-900 mb-6">Is Your Organization Rev. 2 Ready? A Quick Self-Check</h2>
                <ul className="list-disc pl-6 space-y-3 text-slate-700 mb-12">
                ...
                <h2 className="text-3xl font-bold text-slate-900 mb-6">How D-Secure Supports NIST 800-88 Rev. 2</h2>
                <p className="text-slate-700 leading-relaxed mb-6">
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-24 space-y-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200">
                <h3 className="text-xl font-bold text-slate-900 mb-6">Compliance Checker</h3>
