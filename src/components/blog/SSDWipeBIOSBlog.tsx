          ...
          <Reveal>
            <div className="text-center px-6">
              ...
              <p className="text-xl md:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed">
                ...
                and discover why professional data-wiping software is essential
                for business use.
              </p>
            </div>
          </Reveal>
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-slate-700">
                    ...
                    where compliance documentation isn't required. For business
                    use, professional software is recommended.
                  </p>
                </div>
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  <h3 className="font-bold text-slate-900 text-lg mb-2">
                  ...
                  <p className="text-slate-700">
                    ...
                    systems, manufacturer-dependent availability, and no
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-slate-700">
                    ...
                    time in enterprise environments while generating individual
                    compliance reports for each drive.
                  </p>
                </div>
              </div>
            </div>
