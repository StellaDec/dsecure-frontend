          ...
          <div className="bg-white rounded-[2rem] shadow-xl border border-slate-200/50 p-8 md:p-12 space-y-10 text-justify">
            ...
            <div className="space-y-4">
              ...
              <div className="p-6 bg-rose-50 border-l-4 border-rose-500 rounded-r-lg my-4">
                <strong className="text-rose-800 block mb-2">
                  Core Principle
                </strong>
            ...
            <div className="space-y-4">
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-4">
                <div className="bg-rose-50 border border-rose-200 p-4 rounded-lg">
                  <h3 className="font-bold text-rose-900 mb-2">🔐 Identity</h3>
                ...
                <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg">
                  <h3 className="font-bold text-orange-900 mb-2">📱 Device</h3>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-slate-700">
                ...
                <li className="flex gap-3 items-start">
                  ...
                  <span>
                    <strong>Verify Vendors:</strong> Audit <Link to="/solutions/itad" className="text-emerald-600 hover:underline font-medium">ITAD</Link> partners
        ...
        <Reveal>
          <div className="bg-white rounded-[2rem] shadow-xl border border-slate-200/50 p-8 md:p-12 space-y-10 text-justify">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-br from-rose-50 to-red-50 p-6 rounded-xl border border-rose-100">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-bold text-slate-900">Vendor Oversight</h3>
                </div>
                <p className="text-sm text-slate-600">
                  Real-time visibility into <Link to="/solutions/itad" className="text-emerald-600 hover:underline font-medium">ITAD</Link> partner operations. Verify
            ...
            <div className="bg-slate-900 rounded-xl p-6 text-white">
              <h3 className="font-bold mb-4 text-rose-400">
              ...
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                ...
                <div className="flex items-start gap-2">
                  <CheckIcon
                    ...
                    filled={true}
                  />
                  <span>Real-time <Link to="/solutions/itad" className="text-emerald-600 hover:underline font-medium">ITAD</Link> partner monitoring</span>
                </div>
              </div>
            </div>
          </div>
