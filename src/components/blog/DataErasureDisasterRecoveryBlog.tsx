...
const DataErasureDisasterRecoveryBlog: React.FC = () => {
    return (
                ...
                <Reveal>
                    <div className="bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 rounded-xl shadow-lg p-10 mt-10 text-white">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white/10 rounded-xl p-6">
                                <div className="flex items-start gap-4">
                                    <span className="bg-white text-emerald-800 rounded-full w-10 h-10 flex items-center justify-center font-bold text-lg flex-shrink-0">6</span>
                                    <div>
      ...
      <EngagementSection blogId="data-erasure-disaster-recovery" />
        ...
        <Reveal>
          <CommentSection blogId="data-erasure-disaster-recovery" />
        </Reveal>
        <Reveal>
          <EnquiryForm 
            blogId="data-erasure-disaster-recovery" 
            blogTitle="Data Erasure Disaster Recovery" 
          />
        </Reveal>
      </section>
