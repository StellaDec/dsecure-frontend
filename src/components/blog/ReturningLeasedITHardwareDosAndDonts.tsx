          ...
          <div className="bg-white p-10 rounded-xl shadow-sm border">
            ...
            <div className="space-y-6 text-slate-700 leading-loose">
              ...
              <p>
                ...
                controlled handling during transit and handover.
              </p>
              ...
              <p>
                ...
                can be restored after devices are sanitized and returned.
              </p>
              ...
              <p>
                ...
                documentation protect against financial penalties.
              </p>

              <p>
                <strong>Execute Certified Data Erasure:</strong> Before physical
                handover, apply NIST SP 800-88 compliant Clear or Purge methods
          ...
          <div className="bg-white p-10 rounded-xl shadow-sm border">
            ...
            <div className="space-y-6 text-slate-700 leading-loose">
              ...
              <p>
                ...
                erasure. These records protect the organization against legal,
        ...
        <Reveal>
          <div className="bg-emerald-50 border border-emerald-200 p-10 rounded-xl">
            ...
            <p className="text-slate-700 leading-loose mb-4">
              ...
              certified data sanitization aligned with <Link to="/products/drive-eraser" className="text-emerald-600 hover:underline font-medium"><Link to="/compliance/nist-800-88" className="text-emerald-600 hover:underline font-medium">NIST 800-88</Link></Link>, ISO 27001,
