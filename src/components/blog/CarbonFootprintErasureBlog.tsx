          ...
          <div className="text-center px-6">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-6 leading-tight">
              <span className="bg-gradient-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">
                Reducing Carbon Footprint Through Data Erasure
              </span>
            </h1>
            <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
              How compliance-verified data erasure enables IT asset reuse,
              reducing e-waste and lowering your organization's carbon footprint
              significantly.
            </p>
          </div>
        </Reveal>
          ...
          <div className="bg-white rounded-xl shadow-md border border-slate-200/50 p-8 space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-700 leading-relaxed text-lg">
                ...
                globally. Manufacturing new IT equipment contributes
                significantly to carbon emissions through mining, processing,
                and production.
              </p>
              <p className="text-slate-700 leading-relaxed">
                The irony is that many devices are destroyed prematurely simply
                because organizations lack compliance-verified methods to
                sanitize data. Physical destruction eliminates any possibility
                of reuse, sending functional hardware to landfills.
              </p>
              <div className="p-6 bg-emerald-50 border-l-4 border-emerald-500 rounded-r-lg my-4">
                ...
                <p className="text-sm text-emerald-700">
                  According to the UN,{" "}
                  <strong>53.6 million metric tonnes</strong> of e-waste was
                  generated globally in 2019. Only 17.4% was properly recycled.
                  Extending device life through data erasure and reuse can
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-slate-900">
                2. Manufacturing vs. Reuse: Carbon Comparison
              </h2>
              <p className="text-slate-700 leading-relaxed">
                The carbon footprint of IT equipment is heavily front-loaded in
                manufacturing. Extending device life through compliance-verified
                erasure and resale offers substantial environmental benefits.
              </p>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-slate-900">
                3. Data Erasure: Enabling the Circular Economy
              </h2>
              <p className="text-slate-700 leading-relaxed">
                Compliance-verified data erasure is the bridge between secure
                decommissioning and sustainable reuse. Without it, organizations
                face a false choice between security and sustainability.
              </p>
              ...
              <p className="text-slate-700 leading-relaxed">
                ...
                generates financial returns through asset recovery, creating a
                win-win for both ESG goals and the bottom line.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-slate-900">
                4. ESG Reporting and Carbon Metrics
              </h2>
              <p className="text-slate-700 leading-relaxed">
                Environmental, Social, and Governance (ESG) reporting
                increasingly requires organizations to disclose their
                environmental impact. IT asset disposition plays a key role in
                these metrics.
              </p>
              <ul className="space-y-3 text-slate-700">
                <li className="flex gap-3 items-start">
                  ...
                  <span>
                    <strong>Scope 3 Emissions:</strong> End-of-life treatment of
                    products falls under Scope 3. Proper erasure and reuse
                ...
                <li className="flex gap-3 items-start">
                  <span className="text-emerald-500 font-bold text-xl">✓</span>
                  <span>
                    <strong>Waste Reduction:</strong> Track and report devices
                    diverted from destruction through compliance-verified
                    erasure.
                  </span>
                </li>
                <li className="flex gap-3 items-start">
                  <span className="text-emerald-500 font-bold text-xl">✓</span>
                  <span>
                    <strong>Circular Economy Metrics:</strong> Report on asset
                    recovery rates and reuse percentages as sustainability KPIs.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <Reveal>
          <div className="bg-white rounded-xl shadow-md border border-slate-200/50 p-8 mt-8">
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              D-Secure provides the compliance-verified data erasure
              capabilities that enable safe device reuse, helping organizations
              meet their sustainability targets while maintaining data security.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-6 rounded-xl border border-emerald-100">
                ...
                <p className="text-sm text-slate-600">
                  ...
                  carbon savings from asset reuse to support ESG disclosures.
                </p>
              </div>
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-6 rounded-xl border border-emerald-100">
                <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-sm text-slate-600">
                  ...
                  enabling confident resale or donation of retired equipment.
                </p>
              </div>
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-6 rounded-xl border border-emerald-100">
                <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-sm text-slate-600">
                  ...
                  partners for complete chain-of-custody documentation.
                </p>
              </div>
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-6 rounded-xl border border-emerald-100">
                <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-sm text-slate-600">
                  ...
                  savings from your data erasure and reuse program.
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-900 rounded-xl p-6 text-white">
              ...
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  />
                  <span>
                    Enable 85%+ devices for reuse instead of destruction
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckIcon
                ...
                <div className="flex items-start gap-2">
                  ...
                  />
                  <span>
                    Support circular economy initiatives with
                    compliance-verified erasure
                  </span>
                </div>
                <div className="flex items-start gap-2">
        ...
        <Reveal>
          <div className="bg-gradient-to-br from-emerald-600 via-green-600 to-teal-600 rounded-xl shadow-lg p-8 mt-8 text-white">
            ...
            <p className="leading-relaxed mb-6">
              Data security and environmental sustainability are not competing
              priorities. Compliance-verified data erasure enables organizations
              to protect sensitive information while significantly reducing
              their carbon footprint through IT asset reuse. Make erasure the
              cornerstone of your sustainable IT strategy.
            </p>
            <Link
              to="/all-products"
