          ...
          <Reveal>
            <div className="text-center px-6">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-8 leading-tight">
                Flexible Deployment Options for D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link>
              </h1>
        ...
        <section className="max-w-[95%] lg:max-w-6xl mx-auto px-4 md:px-8 py-12">
          <Reveal>
            <div className="bg-white rounded-2xl shadow-lg border border-sky-100 p-8 md:p-12 space-y-10 text-justify">
              ...
              <p className="text-slate-700 leading-loose text-lg">
                D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link> addresses the erasure needs of
              ...
              <div className="space-y-8">
                <div className="border-l-4 border-sky-500 pl-8 py-4">
                  ...
                  <p className="text-slate-700 text-lg leading-loose mb-4">
                    Both D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link> Cloud and Offline variants can be
                    deployed using a bootable USB to erase PCs, laptops, and
                    servers.
                  </p>

                  <h3 className="font-bold text-sky-700 text-lg mb-3 mt-6">
                    For PCs, Laptops, and Servers:
                  </h3>
                  <ul className="space-y-2 text-slate-700">
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-sky-500 rounded-full mr-3 mt-2"></span>
                      Login to D-Secure Cloud Console
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-sky-500 rounded-full mr-3 mt-2"></span>
                      Download the D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link> ISO image
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-sky-500 rounded-full mr-3 mt-2"></span>
                  ...
                  <p className="text-slate-700 text-lg leading-loose mb-3">
                    ...
                    Mac variant of D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link> to wipe Mac with M3,
                    M2, M1, T2, T1 chips:
                  </p>
                  <ul className="space-y-2 text-slate-700">
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-sky-500 rounded-full mr-3 mt-2"></span>
                      Login and download D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link> for Mac from the
                      Cloud console
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-sky-500 rounded-full mr-3 mt-2"></span>
                ...
                <div className="border-l-4 border-sky-500 pl-8 py-4">
                  ...
                  <ul className="space-y-2 text-slate-700">
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-sky-500 rounded-full mr-3 mt-2"></span>
                      Download the D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link> Network Cloud variant
          ...
          <Reveal>
            <div className="bg-sky-50 border border-sky-200 rounded-xl p-10 mt-10 space-y-6">
              ...
              <p className="text-slate-700 leading-loose text-lg">
                D-Secure <Link to="/products/drive-eraser" className="text-sky-600 hover:underline font-medium">Drive Eraser</Link> offers flexible deployment options to meet
