...
const DeploymentOptionsBlog: React.FC = () => {
    return (
                        ...
                        <div className="space-y-8">
                            <div className="border-l-4 border-emerald-500 pl-8 py-4">
                                ...
                                <ul className="space-y-2 text-slate-700">
                                    ...
                                    <li className="flex items-start"><span className="w-2 h-2 bg-emerald-500 rounded-full mr-3 mt-2"></span>Create a bootable USB using a tool like UNetbootin. Download for: <a href="https://downloads.dsecuretech.com/tools%20for%20usb%20bootable/unetbootin-windows-702.exe" className="text-emerald-600 hover:text-emerald-700 font-medium ml-1" target="_blank" rel="noreferrer">Windows</a>, <a href="https://downloads.dsecuretech.com/tools%20for%20usb%20bootable/unetbootin-linux64-702.bin" className="text-emerald-600 hover:text-emerald-700 font-medium ml-1" target="_blank" rel="noreferrer">Linux</a>, <a href="https://downloads.dsecuretech.com/tools%20for%20usb%20bootable/unetbootin-mac-702.dmg" className="text-emerald-600 hover:text-emerald-700 font-medium ml-1" target="_blank" rel="noreferrer">Mac</a></li>
      ...
      <FAQSection faqs={blogFaqs["deployment-options"]} />
