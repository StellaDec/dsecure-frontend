        ...
        <section className="max-w-[95%] lg:max-w-6xl mx-auto px-4 md:px-8 py-12">
          ...
          <Reveal>
            <div className="prose prose-emerald prose-lg md:prose-xl max-w-none prose-headings:font-bold prose-headings:text-[#0a2e1e] prose-p:leading-loose text-[#5a6672] text-justify mb-8">
              ...
              <div className="bg-[#d4ede4] border border-[#d0d5dc] rounded-none p-8 mt-6">
          ...
          <Reveal>
            <div className="prose prose-emerald prose-lg md:prose-xl max-w-none prose-headings:font-bold prose-headings:text-[#0a2e1e] prose-p:leading-loose text-[#5a6672] text-justify mb-8">
              ...
              <div className="overflow-x-auto rounded-none border border-[#d0d5dc]">
                <table className="w-full text-left border-collapse min-w-[600px]">
                  <thead>
                    <tr className="bg-[#f4fbf8] text-[#0a2e1e]">
                      <th className="border-b border-[#d0d5dc] px-6 py-4 font-bold w-1/3">Data Classification</th>
                      <th className="border-b border-[#d0d5dc] border-l px-6 py-4 font-bold w-1/3">On-site Erasure</th>
                      <th className="border-b border-[#d0d5dc] border-l px-6 py-4 font-bold w-1/3">Off-site Destruction</th>
                    </tr>
                  </thead>
                  <tbody className="text-[#5a6672]">
                    <tr>
                      <td className="border-b border-[#d0d5dc] px-6 py-4 font-semibold text-[#0a2e1e]">Public / General Data</td>
                      <td className="border-b border-[#d0d5dc] border-l px-6 py-4">Optional. <br/><span className="text-sm text-[#5a6672]">Only needed if devices are being repurposed internally.</span></td>
                      <td className="border-b border-[#d0d5dc] border-l px-6 py-4 bg-[#d4ede4]">Recommended. <br/><span className="text-sm text-[#5a6672]">Most cost-effective for bulk disposal of low-risk assets.</span></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border-l border-[#d0d5dc] px-6 py-4 bg-[#d4ede4] text-[#0a2e1e] font-medium">Highly Recommended. <br/><span className="text-sm text-[#0a2e1e]">Eliminates "chain of custody" transport risks entirely.</span></td>
                      <td className="border-l border-[#d0d5dc] px-6 py-4 bg-[#f4fbf8]">High Risk. <br/><span className="text-sm text-[#0a2e1e]">A lost truck is an immediate breach notification event under HIPAA.</span></td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <Reveal>
            <div className="prose prose-emerald prose-lg md:prose-xl max-w-none prose-headings:font-bold prose-headings:text-[#0a2e1e] prose-p:leading-loose text-[#5a6672] text-justify mb-8">
              <h2 className="text-3xl font-bold text-[#0a2e1e] mb-6">Cost Comparison & Regulatory Impact</h2>
              
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-bold text-[#0a2e1e] mb-4">Cost Considerations (Per-Drive)</h3>
                  ...
                  <ul className="space-y-4 text-[#5a6672]">
                    <li className="flex items-start">
                      ...
                      <div>
                        <strong>Off-site <Link to="/solutions/itad" className="text-[#0e7c66] hover:text-[#0e7c66] underline underline-offset-4">ITAD</Link>:</strong> Typically ranges from <strong>$3 to $10 per drive</strong>. However, there are hidden costs: secure transport fees, armed guard requirements, and audit overhead.
                      </div>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-[#0e7c66] rounded-full mr-3 mt-2"></span>
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#0a2e1e] mb-4">When Regulations Mandate On-site</h3>
                  <p className="text-[#5a6672] leading-relaxed">
                    Under <strong>HIPAA</strong> and <strong>GDPR</strong>, the moment a hard drive containing PHI or PII leaves your facility unencrypted and un-wiped, you assume maximum liability. <Link to="/compliance" className="text-[#0e7c66] hover:text-[#0e7c66] font-medium underline underline-offset-4">Learn more about our compliance standards.</Link>
                  </p>
                  <div className="bg-[#f4fbf8] border-l-4 border-[#0e7c66] p-4 mt-4 text-[#0a2e1e] text-sm">
          ...
          <Reveal>
            <div className="prose prose-emerald prose-lg md:prose-xl max-w-none prose-headings:font-bold prose-headings:text-[#0a2e1e] prose-p:leading-loose text-[#5a6672] text-justify mb-8">
              <h2 className="text-3xl font-bold text-[#0a2e1e] mb-6">Chain-of-Custody: The Certificate Differences</h2>
              <p className="text-[#5a6672] leading-loose text-lg">
              ...
              <div className="space-y-6">
                <div className="bg-[#f4fbf8] border border-[#d0d5dc] rounded-none p-6">
                  <h3 className="font-bold text-[#0a2e1e] text-lg mb-2">Off-site Physical Destruction Certificate</h3>
