...
export const DatabaseIcon: React.FC<IconProps> = ({ className = "w-6 h-6", filled = false }) => (
  <svg className={className} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke={filled ? "none" : "currentColor"}>
    {filled ? (
      <path d="M12 2C8 2 4 3.58 4 6v2c0 2.42 4 4 8 4s8-1.58 8-4V6c0-2.42-4-4-8-4z M4 14v2c0 2.42 4 4 8 4s8-1.58 8-4v-2c0 2.42-4 4-8 4s-8-1.58-8-4z M4 10v2c0 2.42 4 4 8 4s8-1.58 8-4v-2c0 2.42-4 4-8 4s-8-1.58-8-4z"/>
    ) : (
...
export const ClipboardIcon: React.FC<IconProps> = ({ className = "w-6 h-6", filled = false }) => (
  <svg className={className} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke={filled ? "none" : "currentColor"}>
    {filled ? (
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 4h2a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h2m8 0V3a1 1 0 00-1-1H9a1 1 0 00-1 1v1m8 0a1 1 0 01-1 1H9a1 1 0 01-1-1 M9 12l2 2 4-4" />
    )}
  </svg>
);
...
// Tag Icon
export const TagIcon: React.FC<IconProps> = ({ className = "w-6 h-6", filled = false }) => (
  <svg className={className} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke={filled ? "none" : "currentColor"}>
    {filled ? (
...
// User Icon (Singular)
export const UserIcon: React.FC<IconProps> = ({ className = "w-6 h-6", filled = false }) => (
  <svg className={className} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke={filled ? "none" : "currentColor"}>
    {filled ? (
...
// MonitorIcon
export const MonitorIcon: React.FC<IconProps> = ({ className = "w-6 h-6", filled = false }) => (
  <svg className={className} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke={filled ? "none" : "currentColor"}>
    {filled ? (
      <path d="M20 3H4c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h3l-1 1v2h10v-2l-1-1h3c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 13H4V5h16v11z"/>
    ) : (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13V5a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" />
    )}
  </svg>
);

// ActivityIcon
export const ActivityIcon: React.FC<IconProps> = ({ className = "w-6 h-6", filled = false }) => (
  <svg className={className} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke={filled ? "none" : "currentColor"}>
    {filled ? (
      <path d="M22 12h-4l-3 9L9 3 l-3 9H2"/>
    ) : (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M22 12h-4l-3 9L9 3 l-3 9H2" />
    )}
  </svg>
);

// CpuIcon
export const CpuIcon: React.FC<IconProps> = ({ className = "w-6 h-6", filled = false }) => (
  <svg className={className} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} stroke={filled ? "none" : "currentColor"}>
    {filled ? (
      <path d="M15 9H9v6h6V9zm-2 4h-2v-2h2v2zm8-2V9h-2V7c0-1.1-.9-2-2-2h-2V3h-2v2h-2V3H9v2H7c-1.1 0-2 .9-2 2v2H3v2h2v2H3v2h2v2c0 1.1.9 2 2 2h2v2h2v-2h2v2h2v-2h2c1.1 0 2-.9 2-2v-2h2v-2h-2v-2h2zm-4 6H7V7h10v10z"/>
    ) : (
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 9h6v6H9V9z M9 1v3 M15 1v3 M9 20v3 M15 20v3 M20 9h3 M20 15h3 M1 9h3 M1 15h3 M4 4h16v16H4V4z" />
    )}
  </svg>
);
