...
export const SetupStatusAlert: React.FC = () => {
  ...
  return (
    <div className="bg-[#d4ede4] border-l-4 border-[#d4ede4] p-4 mb-6">
      <div className="flex">
        ...
        <div className="ml-3">
          <h3 className="text-sm font-medium text-[#0a2e1e]">
            Account Setup Required
          </h3>
          <div className="mt-2 text-sm text-[#0a2e1e]">
            <p>
          ...
          <div className="mt-4">
            <div className="-mx-2 -my-1.5 flex">
              <button
                ...
                className="bg-[#d4ede4] px-2 py-1.5 rounded-none text-sm font-medium text-[#0a2e1e] hover:bg-[#d4ede4] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-yellow-50 focus:ring-yellow-600"
              >
                Complete Setup
              </button>
            </div>
